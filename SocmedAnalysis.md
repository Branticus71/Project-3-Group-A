...
![](SocmedAnalysis_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](SocmedAnalysis_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
|:---------------------------|-----------:|
| num_imgs                   | -0.0351543 |
| n_tokens_content           |  0.0653787 |
| n_unique_tokens            | -0.1365617 |
| rate_positive_words        |  0.0013630 |
| rate_negative_words        |  0.0104831 |
| num_videos                 |  0.0077555 |
| num_hrefs                  | -0.0147364 |
| kw_avg_avg                 |  0.1534001 |
| n_tokens_title             | -0.0114686 |
| self_reference_avg_sharess |  0.1814513 |
| avg_positive_polarity      | -0.1171178 |
| avg_negative_polarity      | -0.0553278 |
| monday                     |  0.0172083 |
| tuesday                    | -0.0576474 |
| wednesday                  | -0.0138856 |
| thursday                   | -0.0293661 |
...
![](SocmedAnalysis_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](SocmedAnalysis_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](SocmedAnalysis_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](SocmedAnalysis_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
|:---------------------------|-----:|--------:|---------:|------:|----------:|----------:|-------:|
| self_reference_avg_sharess | 1628 | 8717.37 | 22244.59 |  0.00 | 349050.00 | 349050.00 | 551.31 |
| kw_avg_avg                 | 1628 | 3222.54 |  1260.09 |  0.00 |  36717.23 |  36717.23 |  31.23 |
| n_tokens_content           | 1628 |  604.21 |   548.06 |  0.00 |   4451.00 |   4451.00 |  13.58 |
| num_hrefs                  | 1628 |   13.16 |    15.76 |  0.00 |    171.00 |    171.00 |   0.39 |
| num_imgs                   | 1628 |    4.29 |     8.14 |  0.00 |     62.00 |     62.00 |   0.20 |
| num_videos                 | 1628 |    1.09 |     3.54 |  0.00 |     58.00 |     58.00 |   0.09 |
| n_tokens_title             | 1628 |    9.60 |     2.14 |  4.00 |     18.00 |     14.00 |   0.05 |
| log_shares                 | 1628 |    7.77 |     0.85 |  2.08 |     10.99 |      8.91 |   0.02 |
| rate_positive_words        | 1628 |    0.74 |     0.15 |  0.00 |      1.00 |      1.00 |   0.00 |
| rate_negative_words        | 1628 |    0.25 |     0.14 |  0.00 |      1.00 |      1.00 |   0.00 |
| avg_negative_polarity      | 1628 |   -0.26 |     0.13 | -1.00 |      0.00 |      1.00 |   0.00 |
| n_unique_tokens            | 1628 |    0.54 |     0.12 |  0.00 |      0.97 |      0.97 |   0.00 |
| avg_positive_polarity      | 1628 |    0.36 |     0.10 |  0.00 |      0.83 |      0.83 |   0.00 |
...
| Friday    | 230 |    9 |     4 |     1 |          0 |
| Monday    | 239 |   11 |     1 |     1 |          0 |
| Saturday  | 116 |    3 |     0 |     0 |          0 |
| Sunday    |  81 |    7 |     1 |     0 |          0 |
| Thursday  | 304 |   12 |     4 |     1 |          0 |
| Tuesday   | 295 |   13 |     3 |     0 |          0 |
| Wednesday | 277 |   12 |     2 |     1 |          0 |
...
```
    ...
    ##                                                              RMSE 
    ## "Principal_Component_Regression"              "0.825940731357476" 
    ##                         Rsquared                              MAE 
    ##             "0.0307121841835785"              "0.606214277603104"
...
```
    ...
    ##                                                          RMSE                       Rsquared 
    ## "Forward_Selection_Regression"            "0.815843106058169"           "0.0478236006080349" 
    ##                            MAE 
    ##            "0.597879380958776"
...
```
    ...
    ##                                    RMSE            Rsquared                 MAE 
    ##     "Random_Forest" "0.792634917372719" "0.089112768203018" "0.596903588620056"
...
```
    ...
    ##                                      RMSE             Rsquared                  MAE 
    ##       "Boosted_Tree"  "0.793081941648583" "0.0896846712851428"  "0.596067057828518"
...
```
    ...
    ##   <chr>                          <chr>             <chr>              <chr>            
    ## 1 Random_Forest                  0.792634917372719 0.089112768203018  0.596903588620056
    ## 2 Boosted_Tree                   0.793081941648583 0.0896846712851428 0.596067057828518
    ## 3 Forward_Selection_Regression   0.815843106058169 0.0478236006080349 0.597879380958776
    ## 4 Principal_Component_Regression 0.825940731357476 0.0307121841835785 0.606214277603104

``` r
paste("The top performing model is the", df_selection[1,1], "with a RMSE of", df_selection[1,2], sep = " " )
```

    ## [1] "The top performing model is the Random_Forest with a RMSE of 0.792634917372719"
