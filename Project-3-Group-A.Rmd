...
index_train <- createDataPartition(df_filtered$shares, p = .7, list = FALSE )
...
PCs <- prcomp(select(df_continuous, -log_shares), center = TRUE, scale = TRUE)
par(mfrow = c(1,2))
...
ggplot(categ_day, aes(x = day, y = log(shares), col = day)) + 
